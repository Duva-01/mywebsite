...
f=b.getAttribute("data-layout-desktop");a=function(m){m.w>tbLocalScript.breakpoints.mobile?(b.classList.remove("layout-"+e),b.classList.add("layout-"+f)):(b.classList.remove("layout-"+f),b.classList.add("layout-"+e))};a({w:d.w});d.on("tfsmartresize",a)}}},p=new IntersectionObserver(function(a,b){for(let c=a.length-1;-1<c;--c)!0===a[c].isIntersecting&&(b.unobserve(a[c].target),n(a[c].target))},{threshold:.9});d.on("tb_feature_init",function(a){a instanceof jQuery?a=a.get():void 0===a.length&&(a=[a]);
for(let b=a.length-1;-1<b;--b){let c=a[b].getElementsByClassName("module-feature-chart-html5")[0];c&&p.observe(c)}})})(Themify);
